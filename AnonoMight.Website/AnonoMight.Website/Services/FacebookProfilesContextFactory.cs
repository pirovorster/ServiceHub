...
{
	internal sealed class FacebookProfilesContextFactory : IContextFactory
	{
		public AnonoMightEntities GetContext(string siteName)
		{
			...
			builder.Configurations.Add(new EntityTypeConfiguration<FacebookProfile>());
			builder.Entity<FacebookProfile>().ToTable(siteName, "data");
