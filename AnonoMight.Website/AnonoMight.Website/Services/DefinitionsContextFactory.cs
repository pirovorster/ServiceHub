...
{
	internal sealed class DefinitionsContextFactory : IContextFactory
	{
		public AnonoMightEntities GetContext(string siteName)
		{
			...
			builder.Configurations.Add(new EntityTypeConfiguration<Definition>());
			builder.Entity<Definition>().ToTable(siteName, "data");
