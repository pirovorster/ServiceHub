...
{
	internal sealed class ImagePostsContextFactory : IContextFactory
	{
		public AnonoMightEntities GetContext(string siteName)
		{
			...
			builder.Configurations.Add(new EntityTypeConfiguration<ImagePost>());
			builder.Entity<ImagePost>().ToTable(siteName, "data");
